...
public class ROSInitializer : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        // }
        // 
        ros.AddSubscriber(typeof(BlueRovPoseSubscriber));
        ros.AddSubscriber(typeof(BlueRovCameraSubscriber));
        ros.AddSubscriber(typeof(BlueRovCloudSubscriber));
        ros.AddSubscriber(typeof(BlueRovPressureSubscriber));
        ros.AddPublisher(typeof(BlueRovTeleopPublisher));
        ros.AddPublisher(typeof(LatencyPublisher));
        ros.AddPublisher(typeof(BlueRovPathPlanningPublisher));
        // 
